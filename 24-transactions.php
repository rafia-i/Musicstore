...
$yesterdayDateTime = date('Y-m-d', strtotime('-1 day'));
$query = "SELECT * FROM invoice WHERE date BETWEEN '$yesterdayDateTime' AND '$currentDateTime'";
...
<body>
    ...
    <?php
        displayTransactions($result, "Transactions in the Last 24 Hours");
    ?>
</body>
</html>